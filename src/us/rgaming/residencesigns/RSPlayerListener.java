	...
	public void onPlayerInteract(PlayerInteractEvent event) {
		if (event.getAction().equals(Action.RIGHT_CLICK_BLOCK)) {
			...
			if (block.getState() instanceof Sign) {
				...
				if (signType.equals(ChatColor.DARK_BLUE + "[forsale]") || signType.equals(ChatColor.DARK_BLUE + "[rent]")) {
					...
					if (signType.equals(ChatColor.DARK_BLUE + "[rent]")) {
					...
					} else if (signType.equals(ChatColor.DARK_BLUE + "[forsale]")) {
